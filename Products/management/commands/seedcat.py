...
from Products.models import Collection, Item, ItemCategory
...
def create_category(name):
    ...
    for _ in name:
        ...
        category.save()
        print("{} collection created.".format(category))
    return category
...
def run_seed(self, mode):
    ...
    create_category(['Sweets','Smoothie','Beavarage','Foods','Snacks','Soft Drink','Caffene'])